...
/// [RefreshNoIndicator] far enough to demonstrate that they want the app to
/// refresh. The returned [Future] must complete when the refresh operation is
/// finished.
///
/// Used by [RefreshNoIndicator.onRefresh].
...
/// always scrollable and, therefore, can trigger the [RefreshNoIndicator].
///
/// A [RefreshNoIndicator] can only be used with a vertical scroll view.
///
/// See also:
///
///  * <https://material.google.com/patterns/swipe-to-refresh.html>
///  * [RefreshNoIndicatorState], can be used to programmatically show the refresh indicator.
///  * [RefreshProgressIndicator], widget used by [RefreshNoIndicator] to show
///    the inner circular progress spinner during refreshes.
///  * [CupertinoSliverRefreshControl], an iOS equivalent of the pull-to-refresh pattern.
///    Must be used as a sliver inside a [CustomScrollView] instead of wrapping
///    around a [ScrollView] because it's a part of the scrollable instead of
///    being overlaid on top of it.
class RefreshNoIndicator extends StatefulWidget {
  ...
  @override
  RefreshNoIndicatorState createState() => RefreshNoIndicatorState();
}

/// Contains the state for a [RefreshNoIndicator]. This class can be used to
/// programmatically show the refresh indicator, see the [show] method.
class RefreshNoIndicatorState extends State<RefreshNoIndicator> with TickerProviderStateMixin<RefreshNoIndicator> {
  ...
  ///
  /// Creating the [RefreshNoIndicator] with a [GlobalKey<RefreshIndicatorState>]
  /// makes it possible to refer to the [RefreshNoIndicatorState].
  ///
  /// The future returned from this method completes when the
  /// [RefreshNoIndicator.onRefresh] callback's future completes.
  ///
